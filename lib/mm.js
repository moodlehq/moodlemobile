...
var MM = {
    ...
    loadModels: function(elements) {
        ...
        for (var el in elements) {
            ...
            if (obj.type == 'model') {
                MM.models[el] = Backbone.Model.extend(obj.bbproperties);
            }
            else if (obj.type == 'collection') {
                obj.bbproperties.model = MM.models[obj.model];
                obj.bbproperties.localStorage = new Store(el);
                var col = Backbone.Collection.extend(obj.bbproperties);
                // Now the instance.
                MM.collections[el] = new col();
            }
        }
    },
