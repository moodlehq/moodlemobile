    ...
    loadSite: function(siteId) {
        ...
        MM.moodleWSCall('moodle_enrol_get_users_courses', {userid: site.get('userid')}, function(courses) {
            ...
            for (var el in courses) {
                ...
                var r = MM.collections.courses.create(storedCourse);
            }
        ...
        $.getJSON(loginURL,
            ...
            ,function(json) {
                if(typeof(json.token) != 'undefined'){
                    ...
                    MM.collections['settings'].create({id: "current_token", name: "current_token",value: mytoken});
                    ...
                    MM.moodleWSCall('moodle_webservice_get_siteinfo', {}, function(d) {
                        ...
                        MM.collections['settings'].create({id: "current_site", name: "current_site", value: d});
