...
var MM = {
    ...
    saveSite: function(username, password, siteurl) {
        ...
        MM.widgets.dialog('<div class="centered"><img src="img/loading.gif"></div>', {modal: true, title: MM.lang.s("authenticating"), closeOnEscape: false, draggable: false, resizable: false});
    ...
    moodleUploadFile: function(data, fileOptions, successCallBack, errorCallBack, presets) {
        ...
        MM.widgets.dialog('<img src="img/loading.gif">&nbsp;' + MM.lang.s('uploadingtoprivatefiles'), {modal: true, title: MM.lang.s("uploading")});
    ...
    */
    panels: {
        ...
        goBack: function() {
            ...
            $(showPanel).animate({
                left: 0,
                visibility: 'visible'
              }, 300, function() { $(this).css('visibility', 'visible'); });
     ...
     *
     * @param {string} A selector for handling the links
     */
     ...
     *
     * @param {string} A selector for handling the links to files
     */
