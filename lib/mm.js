    ...
    loadLayout: function() {
        ...
        if (MM.util.isTouchDevice()) {
            if (MM.util.overflowScrollingSupported()){
                ...
                $("#panel-left").addClass("overflow-scroll");
                $("#panel-center").addClass("overflow-scroll");
                $("#panel-right").addClass("overflow-scroll");
                ...
                MM.util.touchScroll('panel-left');
                MM.util.touchScroll('panel-center');
                MM.util.touchScroll('panel-right');
            }
        }
    ...
    panels: {
        ...
        html: function(position, html) {
            ...
            if (position == "right") {
                if (MM.util.isTouchDevice()) {
                    if (MM.util.overflowScrollingSupported()){
                        $('#panel-' + position).css({webkitOverflowScrolling: 'auto', overflow: 'hidden'});
                        setTimeout(function() {
                            $('#panel-' + position).css({webkitOverflowScrolling: 'touch', overflow: 'auto'});
                        }, 10);
                    }
                }
            }
