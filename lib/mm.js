...
var MM = {
    ...
    _openFile: function(link) {
        ...
        if (MM.inNodeWK) {
            ...
            } else if (MM.deviceOS == 'ios' && window.plugins.socialsharing) {
                var fileName = MM.util.getFileNameFromURL(link);
                window.plugins.socialsharing.share(fileName, fileName, link);
