...
/**
  * @namespace Holds all the ifaacampus specific functionallity.
 */
var MM = {
    ...
    /**
     * Set the inMMSimulator flag if the app is running using Ifaa Campus simulator
     * on a computer.
     */
    ...
    _appLaunchedByURL: function(url) {
        ...
        url = url.replace("ifaacampus://token=", "");
        // Decode from base64.
        url = atob(url);
