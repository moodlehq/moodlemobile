...
MM.panels = {
	...
	menuShow: function(show, settings) {
		...
		$('#panel-left, #panel-center, #panel-right, .header-main').css("-webkit-transition", "");
		...
		if (!MM.panels.menuStatus) {
			...
			if (MM.getConfig("dev_css3transitions")) {
				...
				$('#panel-left').css('display', 'block');
				$('#panel-center, #panel-right, .header-main').css("-webkit-transition", "left 0.3s ease-in, width 0.3s ease-in");
