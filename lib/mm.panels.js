	...
	html: function(position, html) {
		...
		if (MM.deviceType == "phone") {
			...
			if (panelRight.css("display") == "block" && position == "right") {
				...
				console.log(html.indexOf("back-row"));
			...
			if (showBackArrow) {
				html = '<div class="back-row"><a onclick="MM.panels.goBack();"><img src="img/arrowleft.png"><span id="back-arrow-title"></span></a></div>' + html;
			}
