...
MM.panels = {
	...
	html: function(position, html) {
		...
		if (MM.deviceType == "phone") {
			...
			if (showBackArrow) {
				html = '<div class="back-row"><a onclick="MM.panels.goBack();"><img src="img/arrowleft.png"></a></div><div id="back-arrow-title"></div>' + html;
			}
			...
			if (showPanelTitle) {
				html = '<div id="tablet-page-title"></div>' + html;
			}
		}
