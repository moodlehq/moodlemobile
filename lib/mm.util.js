...
MM.util = {
    ...
    helpMeLogin: function () {
        MM.widgets.dialog(MM.lang.s("helpmelogin"), {title: MM.lang.s("help"), marginTop: "15%"});
    ...
    /**
     * This functions gets the path of a Moodle file looking online or offline if the Mobile is not connectec to Internet
    ...
    getMoodleFilePath: function (fileurl, courseId) {
        ...
        // We download the file asynchrously
        MM.fs.init(function() {
        ...
        if (MM.deviceConnected()) {
            return MM.fixPluginfile(fileurl);
        } else {
