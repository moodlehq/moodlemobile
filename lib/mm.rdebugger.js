...
MM.rdebugger = {
    ...
    start: function() {
        MM.log("Rdebug: Enabling remote debugging");
    ...
    finish: function() {
        MM.log("Rdebug: Disabling remote debugging");
            ...
            success: function(messages) {
                ...
                $.each(messages, function(index, message) {
                    ...
                    if (message.type == "command" && message.text) {
                        ...
                        MM.rdebugger.streaming = false;
                        responsesQ.push({messageid: message.id, response: 'ACK'});
                    } 
    ...
    streamPage: function(baseURL, messageId) {
        ...
        var page = "<html><head></head><body><style type=\"text/css\">" + cssText + "</style>" + bodyText + "</body></html>";
