...
MM.settings = {
    ...
    showSites: function() {
        ...
        var tpl = '\
            ...
            <div class="button-bottom-only"><a href="#settings/sites/add"><button><%= MM.lang.s("addsite") %></button></a></div>';
    ...
    showGeneral: function() {
        ...
        // Render the settings as html.
        var html = MM.widgets.render(settings);
        html += '<br /><div class="button-bottom-only"><a href="#settings/general/purgecaches"><button> '+ MM.lang.s("purgecaches") + '</button></a></div>';
