...
MM.cordova = {
    ...
    loadEmulator: function() {
        ...
        if(typeof(FileUploadOptions) == "undefined"){
            ...
            MM.log("Fake FileUploadOptions manager loaded");
        }
        if(typeof(FileTransfer)== "undefined"){
            ...
            MM.log("Fake FileTransfer manager loaded");
        }
        if(typeof(navigator.contacts) == "undefined"){
            ...
            MM.log("Fake contacts manager loaded");
        }
        if(typeof(navigator.device) == "undefined"){
            ...
            MM.log("Fake captureAudio manager loaded");
        }
