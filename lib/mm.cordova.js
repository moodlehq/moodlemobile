...
MM.cordova = {
    ...
    loadEmulator: function() {
        ...
        // process is a global object created by node-webkit. We double check with the attribute "versions".
    ...
    loadNodeJSAPI: function() {
        ...
        DirectoryEntry.prototype.getDirectory = function(path, options, successCallback, errorCallback) {
            ...
            if (options.create) {
                ...
                fs.stat(newFullPath, function (err, stats) {
        ...
        DirectoryEntry.prototype.getFile = function(path, options, successCallback, errorCallback) {
            ...
            if (options.create) {
                ...
                fs.stat(filePath, function (err, stats) {
                    if (stats.File()) {
                        var entry = new DirectoryEntry(path, filePath);
                        successCallback(entry);
                        return;
                    }
                    errorCallback();
