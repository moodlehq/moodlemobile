...
MM.cordova = {
    ...
    loadEmulator: function() {
        ...
        navigator.splashscreen = {
            show: function(){
                MM.log('Showing splash screen', 'Cordova fake');
                if( $('#splashimgaddedfromcordovajs').length == 0 ){
                    $('body').append('<img id="splashimgaddedfromcordovajs" src="splash_landscape.png" '
                        +'style="position:absolute;top:0;left:0;width:'+$(window).width()+'px;height:'+$(window).height()+'px;"></img>');
                }
            },
            hide: function(){
                MM.log('Hiding splash screen', 'Cordova fake');
                $('#splashimgaddedfromcordovajs').remove();
            }
        };
    ...
    loadNodeJSAPI: function() {
        ...
        DirectoryEntry.prototype.getParent = function(successCallback, errorCallback) {
            ...
            if (fs.existsSync(parentPath) && fs.statSync(parentPath).isDirectory()) {
                var entry = new DirectoryEntry(parentPath, parentPath); 
                successCallback(entry);
            } else {
                if(errorCallback)
                    errorCallback();
        ...
        DirectoryEntry.prototype.moveTo = function (parent, newName, successCallback, errorCallback) {
            ...
            var newPath = parent.fullPath + '/' + newName;
        ...
        FileEntry.prototype.getParent = function(successCallback, errorCallback) {
            ...
            this.getDirectory(parentPath, {create: false, exclusive: false}, successCallback, errorCallback);
        ...
        FileEntry.prototype.moveTo = function (parent, newName, successCallback, errorCallback) {
            ...
            fs.rename(this.fullPath, parent.fullPath + '/' + newName, 
                function(err){
                    if(err){
                        if(errorCallback)
                            errorCallback();
        ...
        navigator.camera.getPicture = function(captureSuccess, captureError, options) {
            ...
            if (options.sourceType == navigator.camera.PictureSourceType.PHOTOLIBRARY) {
                ...
                buttons[MM.lang.s('takephoto')] = function() {
                    ...
                    $(".modal-button-0").html(MM.lang.s('upload')).on(MM.quickClick, function(e) {
        ...
        navigator.device.capture.captureAudio = function(captureSuccess, captureError, options) {
            ...
            buttons[MM.lang.s('record')] = function() {
                ...
                navigator.webkitGetUserMedia({audio: true}, function (s) {
                    ...
                    $(".modal-button-0").html(MM.lang.s('stop')).on(MM.quickClick, function(e) {
                        recorder.stop();
