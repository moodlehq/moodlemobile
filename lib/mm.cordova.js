...
/**
 * @fileoverview Moodle mobile cordova lib.
...
/**
  * @namespace Holds all the MoodleMobile cordoba functionallity.
 */
MM.cordova = {
    ...
    loadEmulator: function() {
        ...
        if(typeof(FileTransfer)== "undefined"){
            ...
            window.FileTransfer.prototype.download = function(url, filePath, successCallback, errorCallback, options, debug) {
                MM.log("Cordova: Fake FileTransfer Download");
                setTimeout(successCallback,3000);
            }
            MM.log("Cordova fake: FileTransfer manager loaded");
        }
        if(typeof(navigator.contacts) == "undefined"){
            ...
            MM.log("Cordova fake: contacts manager loaded");
        }
        if(typeof(navigator.device) == "undefined"){
            ...
            MM.log("Cordova fake: captureAudio manager loaded");
        }
        ...
        if (typeof(window.requestFileSystem) == "undefined") {
            ...
            MM.log("Cordova fake: FileManager loaded");
        }
    ...
    'YII=');
            ...
            MM.log("Cordova fake: navigator.camera manager loaded");
        }
        
        $(document).trigger("deviceready");
        MM.log("Cordova fake: Emulator loaded, fired deviceready");
